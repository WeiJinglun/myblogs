...
![MySQL-17-2](img/MySQL-17-2.png)

图中的 pos 就是**位置信息**，你可能会觉得奇怪，这里的“位置信息”是个什么概念？

这时候，就要回到一个基本概念：**MySQL 的表是用什么方法来定位“一行数据”的。**

如果你创建的表没有主键，或者把一个表的主键删掉了，那么 InnoDB 会自己生成一个**长度为 6 字节的 rowid** 来作为主键。
